...
|---|---------|-------|------------|--------|
| 01 | [Patch Management and Health Validation](projects/01-patch-management/) | Safe maintenance and change | Ansible, Bash, Jinja2, Linux | Complete |
...
| 03 | [Backup, Restore and Recovery](projects/03-backup-recovery/) | Recovery, RTO/RPO | Bash, AWS CLI, S3, Ansible | Planned |
